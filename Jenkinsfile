///// Common variables /////
env.git_repo_name="git@github.com:gtaydbs/jenkins_pipeline_test" // update this value as created in Step 9 above
env.git_id="gtaydbs"  // update this value as created in Step 9 above
